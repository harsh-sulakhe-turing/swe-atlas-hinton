...
from autoqc.agent.checks import (SemanticCheck, Q07, Q03, Q01, Q02, Q05, Q04, Q08, Q10, Q11, P02, P03, A01, A02, A03, A04, A05, AL01, Q13, SEMANTIC_CHECKS,
...
def test_registry_and_severities():
    assert set(c.id for c in SEMANTIC_CHECKS) == {"Q01", "Q02", "Q03", "Q04", "Q05", "Q07", "Q08", "Q10", "Q11", "P02", "P03", "A01", "A02", "A03", "A04", "A05", "AL01", "Q13"}
    ...
    assert all(c.severity is Severity.WARN for c in [AL01])
    assert all(c.severity is Severity.REJECT for c in [Q13])
